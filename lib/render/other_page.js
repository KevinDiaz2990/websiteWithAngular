...
/**/) {
var out='<!DOCTYPE html><html><title>Other Page </title><body>  ';if(it.name){out+='<p>HI '+(it.name)+' </p> ';}else{out+='<p> This is another page to view </p>';}out+='</body></html>';return out;
